...
const Home = () => {
  return (
    <div className='w-screen h-screen flex justify-evenly items-center font-sans'>
      <div className='flex flex-col gap-36'>
        <div className='w-[390px]'>
          <h1 className='text-4xl font-semibold pb-3'>Hello, I'm</h1>
          <h1 className='text-4xl font-semibold pb-3'>Md. Zahidul Islam Mollik</h1>
